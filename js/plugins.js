...
!function() {
  ...
  var x = []
    ...
    , j = function() {
      function t(i, n) {
          ...
          g && "object" === ("undefined" == typeof g ? "undefined" : a(g)) && "undefined" != typeof g.length && (g = g[0]),
      ...
      return r(t, [{
          key: "css",
          value: function(e, t) {
              return "string" == typeof t ? window.getComputedStyle ? window.getComputedStyle(e).getPropertyValue(t) : e.style[t] : (t.transform && (m && (t.transform += " translateZ(0)"),
          ...
          value: function() {
              ...
              e.image.useImgTag ? (e.image.$item || (e.image.$item = document.createElement("img"),
              ...
              (a || "opacity" === e.options.type || "scale" === e.options.type || "scale-opacity" === e.options.type || 1 === e.options.speed) && (e.image.position = "absolute"),
          ...
          value: function() {
              var e = this
                ...
                , r = i
                , s = 0;
              return o && (a = n < 0 ? n * Math.max(i, v) : n * (i + v),
              n > 1 ? r = Math.abs(a - v) : n < 0 ? r = a / n + Math.abs(a) : r += Math.abs(v - i) * (1 - n),
              a /= 2),
          ...
          value: function(e) {
              ...
              t.isElementInViewport = r.bottom >= 0 && r.right >= 0 && r.top <= v && r.left <= h,
              e || t.isElementInViewport) {
                  var s = Math.max(0, n)
                    ...
                    , d = 1 - 2 * (v - n) / (v + o)
                    , f = 1;
                  if (o < v ? f = 1 - (m || c) / o : l <= v ? f = l / v : p <= v && (f = p / v),
                  "opacity" !== t.options.type && "scale-opacity" !== t.options.type && "scroll-opacity" !== t.options.type || (a.transform = "",
                  a.opacity = f),
    ...
    , S = function(e) {
      ...
      var t = arguments[1]
        ...
        , r = void 0;
      for (o; o < n; o++)
          if ("object" === ("undefined" == typeof t ? "undefined" : a(t)) || "undefined" == typeof t ? e[o].jarallax || (e[o].jarallax = new j(e[o],t)) : e[o].jarallax && (r = e[o].jarallax[t].apply(e[o].jarallax, i)),
          "undefined" != typeof r)
              return r;
      return e
  };
  ...
  if (window.jarallax = S,
  window.jarallax.noConflict = function() {
      return window.jarallax = I,
      this
  }
  ,
  ...
  var n = 0
    ...
    , y = function() {
      ...
      return a(t, [{
          ...
          value: function(e) {
              var t = this;
              t.player && ("youtube" === t.type && t.player.playVideo && ("undefined" != typeof e && t.player.seekTo(e || 0),
              YT.PlayerState.PLAYING !== t.player.getPlayerState() && t.player.playVideo()),
              "vimeo" === t.type && ("undefined" != typeof e && t.player.setCurrentTime(e),
          ...
          value: function(e) {
              ...
              return t.$iframe ? void e(t.$iframe) : void t.onAPIready(function() {
                  ...
                  var a = void 0;
                  if (t.$iframe || (a = document.createElement("div"),
                  ...
                  "youtube" === t.type) {
                      ...
                      t.options.controls || (t.playerOptions.playerVars.iv_load_policy = 3,
                      ...
                      t.playerOptions.events = {
                          ...
                          onStateChange: function(e) {
                              ...
                              n || e.data !== YT.PlayerState.PLAYING || (n = 1,
                              t.fire("started", e)),
                              ...
                              t.options.endTime && (e.data === YT.PlayerState.PLAYING ? r = setInterval(function() {
                      ...
                      p && (t.$iframe = document.getElementById(t.playerID),
                      t.videoWidth = parseInt(t.$iframe.getAttribute("width"), 10) || 1280,
                      t.videoHeight = parseInt(t.$iframe.getAttribute("height"), 10) || 720)
                  }
                  if ("vimeo" === t.type) {
                      t.playerOptions = "",
                      t.playerOptions += "player_id=" + t.playerID,
                      t.playerOptions += "&autopause=0",
                      t.options.controls || (t.playerOptions += "&badge=0&byline=0&portrait=0&title=0"),
                      t.playerOptions += "&autoplay=" + (t.options.autoplay ? "1" : "0"),
                      t.playerOptions += "&loop=" + (t.options.loop ? 1 : 0),
                      t.$iframe || (t.$iframe = document.createElement("iframe"),
                      t.$iframe.setAttribute("id", t.playerID),
                      t.$iframe.setAttribute("src", "https://player.vimeo.com/video/" + t.videoID + "?" + t.playerOptions),
                  ...
                  if ("local" === t.type) {
                      t.$iframe || (t.$iframe = document.createElement("video"),
                      t.options.mute ? t.$iframe.muted = !0 : t.$iframe.volume && (t.$iframe.volume = t.options.volume / 100),
          ...
          value: function(e) {
              ...
              "vimeo" === t.type)
                  if ("undefined" != typeof Vimeo || s)
                      "undefined" != typeof Vimeo ? e() : d.done(function() {
                          e()
                      });
                  else {
                      s = 1;
                      var i = setInterval(function() {
                          "undefined" != typeof Vimeo && (clearInterval(i),
                          d.resolve("done"),
                          e())
                      }, 20)
                  }
              ...
              if (i.isValid())
                  if (t) {
                      ...
                      !e.defaultInitImgResult)
                          ...
                          !1) : (e.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",
                          !0)
                  } else
